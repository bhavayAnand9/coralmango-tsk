...
let HomepageComponent = class HomepageComponent {
    constructor(_homePageService) {
        this._homePageService = _homePageService;
        this.files = [];
        this.fileUrl = undefined;
    }
    ngOnInit() {
        this._homePageService.getFiles().subscribe(res => {
...
let RegisterComponent = class RegisterComponent {
    constructor(_auth, _router) {
        this._auth = _auth;
        this._router = _router;
        this.registerUserData = new class {
        };
    }
    ngOnInit() {
    }
...
UploadServiceService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let UploadComponent = class UploadComponent {
    constructor(_upload, _http, router) {
